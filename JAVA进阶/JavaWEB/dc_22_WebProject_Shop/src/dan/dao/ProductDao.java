...
import dan.domain.OrderItem;
import dan.domain.PageBean;
...
public class ProductDao {
	...
	public List<Product> findHotProductList() throws SQLException {
		...
		List<Product> list = runner.query(sqlString, new BeanListHandler<Product>(Product.class), 1, 0, 9);
		return list;
	}
	...
	public List<Product> findNewProductList() throws SQLException {
		...
		List<Product> list = runner.query(sqlString, new BeanListHandler<Product>(Product.class), 0, 9);
		return list;
	}
	...
	public List<Category> findAllCategory() throws SQLException {
		...
		List<Category> categories = runner.query(sqlString, new BeanListHandler<Category>(Category.class));
		return categories;
	}
	...
	public void addOrders(Order order) throws SQLException {
		...
		int success = runner.update(conn, sql, order.getOid(), order.getOrdertime(), order.getTotal(), order.getState(),
