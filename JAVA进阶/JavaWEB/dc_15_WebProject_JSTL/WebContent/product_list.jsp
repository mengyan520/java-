	...
	<div class="row" style="width: 1210px; margin: 0 auto;">
		...
		<c:forEach items="${products}" var="product">
			<div class="col-md-2" style="height:250px">
				<a href="product_info?pid=${product.pid }"> <img src="${pageContext.request.contextPath }/${product.pimage }"
					width="170" height="170" style="display: inline-block;">
				</a>
				<p>
					<a href="product_info?pid=${product.pid }" style='color: green'>${product.pname} </a>
				</p>
				<p>
		...
		<%-- <%
			...
			if (productList != null) {
				for (Product product : productList) {
					...
					out.write("<img src='" + product.getPimage()
							+ "' width='170' height='170' style='display: inline-block;'>");
					out.write("</a>");
